...
public class Class_GPSTracker extends Service implements LocationListener  {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(Class_GPSTracker.this);
        }       
    }
    ...
    public void showSettingsAlert()
    {
       ...
       /* alertDialog.show();*/
		...
		ImageView iv_locationimage = dialog.findViewById(R.id.locationdialog_IV);
		iv_locationimage.setImageResource(R.drawable.location5);
	Button dialogsettingbutton = dialog.findViewById(R.id.settingdialog_BT);
