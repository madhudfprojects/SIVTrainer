...
public class Class_Assessments_List {
    ...
    public static ArrayList<Class_Assessments_List> assesmentlistview_info_arr_new=new ArrayList<Class_Assessments_List>();

    public Class_Assessments_List(){}

    public Class_Assessments_List(String assessmentID, String assessmentName, String assessmentDate, String assessmentStatus, String assessment_levelName, String assessment_instituteName,String assessment_instituteID,String assessment_levelID,String assessment_presentstudentcount,String assessment_totalstudentcount,String assessment_maxmarks,String assessment_save) {
