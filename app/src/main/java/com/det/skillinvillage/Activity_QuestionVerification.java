...
public class Activity_QuestionVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Question Paper Verification");
    ...
    public void GetTopicReviewLoad() {
        ...
        progressDoalog = new ProgressDialog(Activity_QuestionVerification.this);
            ...
            public void onResponse(Call<Class_Get_Topic_Review_LoadResponse> call, Response<Class_Get_Topic_Review_LoadResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (class_loginresponse.getStatus()) {
                        ...
                        setValues();
                        ArrayAdapter<Class_Get_Topic_Review_LoadResponseList> dataAdapter_edu = new ArrayAdapter<Class_Get_Topic_Review_LoadResponseList>(Activity_QuestionVerification.this, R.layout.spinnercenterstyle, arrayObj_class_studentpaymentresp);
...
//                        alerts_dialog_getexlistviewError();
                        ...
                        Toast.makeText(Activity_QuestionVerification.this, "Kindly restart your application", Toast.LENGTH_SHORT).show();
...
//                alerts_dialog_getexlistviewError();
    ...
    public void PostTopicReviewUpdate() {
        ...
        progressDoalog = new
                ...
                ProgressDialog(Activity_QuestionVerification.this);
        progressDoalog.setTitle("Please wait....");
        progressDoalog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        // show it
        progressDoalog.show();
        ...
        call.enqueue(new Callback<PostTopicReviewUpdateResponse>() {
            ...
            public void onResponse
                ...
                if (response.isSuccessful()) {
                    ...
                    if (class_loginresponse.getStatus()) {
                        submit_bt.setVisibility(View.GONE);
                        Toast.makeText(Activity_QuestionVerification.this, class_loginresponse.getMessage(), Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(Activity_QuestionVerification.this, DocView_MainActivity.class);
                        startActivity(i);
                        finish();
...
//                        alerts_dialog_getexlistviewError();
                        ...
                        //Toast.makeText(getActivity(), error.getMsg(), Toast.LENGTH_SHORT).show();
                        Toast.makeText(Activity_QuestionVerification.this, error.getMsg(), Toast.LENGTH_SHORT).show();
...
//                alerts_dialog_getexlistviewError();
                ...
                Toast.makeText(Activity_QuestionVerification.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });// end of call
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent i = new Intent(Activity_QuestionVerification.this, DocView_QunPaperActivity.class);
                startActivity(i);
                finish();
...
//                    finish();
//                } else {
//                    Intent i = new Intent(Activity_QuestionVerification.this, DocView_LessonPlanActivity.class);
//                    startActivity(i);
//                    finish();
//
//                }
